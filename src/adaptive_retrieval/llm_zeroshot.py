...
logging.basicConfig(filename='src/adaptive_retrieval/results/llm_'+model_id+'_zeroshot_sensor.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
with open("src/adaptive_retrieval/results/llm_"+model_id+"_zeroshot_sensor.txt", "w") as file:
