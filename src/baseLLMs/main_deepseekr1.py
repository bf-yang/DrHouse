...
model_id_dict = {
    ...
    'deepseek-r1-1.5b': 'unsloth/DeepSeek-R1-Distill-Qwen-1.5B',
}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_base", type=str, default='deepseek-r1-8b',
                        help='deepseek-r1-1.5b, deepseek-r1-8b')   # DrHouse's base LLM
    ...
    # Initialize the local LLM of DrHouse
    ...
    while n_turn < MAX_TURN:
        ...
        # local inference
        response = pipeline(  # llama inference
            conversation,
        ...
        conversation_patient=[{"role": "user", "content": "[ Doctor ]: " + response}]
