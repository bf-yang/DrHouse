...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_version", type=str, default='gpt-4o',
                        help='gpt-35-turbo, gpt-4o or gpt-4-1106')
    ...
    while n_turn < MAX_TURN:
        ...
        # conversation_patient.append({"role": "assistant", "content": "[ Doctor ]: " + response.choices[0].message.content})
        conversation_patient=[{"role": "user", "content": "[ Doctor ]: " + response.choices[0].message.content}]
